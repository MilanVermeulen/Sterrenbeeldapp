...
let year = sessionStorage.getItem('month');
...
//AQUARIUS
if (year == "januari" && day >= "20" || year == "februari" && day <= 18){
  result = ("Aquarius");
...
//PISCES
if (year == "februari" && day >= 19 || year == "maart" && day <= 20){
  result = ("Pisces");
...
//ARIES
if (year == "maart" && day >= 21 || year == "april" && day <= 19){
  result = ("Aries");
...
//TAURUS
if (year == "april" && day >= 20|| year == "mei" && day <= 20){
  result = ("Taurus");
...
//GEMINI
if (year == "mei" && day >= 21 || year == "juni" && day <= 20){
  result = ("Gemini");
...
//CANCER 
if (year == "juni" && day >= 21 || year == "juli" && day <= 22){
  result = ("Cancer");
...
//LEO
if (year == "juli" && day >= 23 || year == "augustus" && day <= 22){
  result = ("Leo");
...
//VIRGO
if (year == "augustus" && day >= 23 || year == "september" && day <= 22){
  result = ("Virgo");
...
//LIBRA  
if (year == "september" && day >= 23 || year == "oktober" && day <= 22){
  result = ("Libra");
...
//SCORPIO
if (year == "oktober" && day >= 23|| year == "november" && day <= 21){
  result = ("Scorpio");
...
//CAPRICORN 
if(year == "december" && day >= 22 || year == "januari" && day <= 19){ 
  result = ("Capricorn");
